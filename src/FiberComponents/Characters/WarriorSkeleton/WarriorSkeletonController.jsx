...
import { WarriorSkeleton } from './WarriorSkeleton';
import { useDispatch, useSelector } from 'react-redux';
import { setAboutGate, setProjectGate, setRaceGate, startTimer } from '@/redux/gateSlice';
...
const WarriorSkeletonController = () => {
  ...
  return (
    <>
                           ...
                           onIntersectionEnter={({ other }) => {
                             ...
                             // if (other.rigidBodyObject.name === "raceGate") {
                           ...
                           >
                               ...
                               <WarriorSkeleton scale={0.58} position-y={-1.25} rotation={[0, THREE.MathUtils.degToRad(180), 0]} animation={animation} castShadow />
...
export default WarriorSkeletonController