    ...
    <NavContainer>
        ...
        <h1
          className={`${
            pathname === '/'
              ...
              : null
          } md:text-2xl text-lg font-extrabold hidden md:flex`}
        >
          Jack Kelley
        </h1>
          ...
          <h1
            className={`${
              pathname === '/'
                ? 'underline underline-offset-4 decoration-accent decoration-2'
                : null
            } flex text-5xl font-extrabold relative`}
          >
            J
          </h1>
          <h1
            className={` ${
              pathname === '/'
                ? 'underline underline-offset-4 decoration-accent decoration-2'
                : null
            } flex text-5xl font-extrabold absolute left-3.5`}
          >
            K
          </h1>
      ...
      <FlexRow className="md:gap-4">
        ...
        <Link
          className={`${
            pathname === '/about'
              ? 'underline underline-offset-4 decoration-accent decoration-3'
              : 'null'
          } ${
            theme === 'jack-light' ? 'text-white' : null
          } md:text-xl text-primary `}
          to="/about"
        >
          About
        </Link>
