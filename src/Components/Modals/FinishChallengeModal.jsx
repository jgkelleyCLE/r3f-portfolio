      ...
      >
        ...
        <div className="flex flex-col gap-2 items-center mx-auto">
          <h1 className="text-lg md:text-xl text-primary">
            Congratulations on finishing the challenge with a time of{' '}
            <span className="font-bold">{formatTime(elapsedTime)}</span>!
          </h1>

          {qualifiesForLeaderboard ? (
            <FlexColumn>
              <h1 className="text-accent text-lg md:text-xl mb-2">
                You qualify for the leaderboard with the {leaderboardPosition}
