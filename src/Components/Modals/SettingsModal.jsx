        ...
        <div className="flex flex-col items-center gap-2 mx-auto w-full">
          <div className="border border-gray-300 p-2 w-full rounded-md flex items-center justify-between">
            ...
            <Switch
              ...
              checked={lowGravity}
              onCheckedChange={(checked) => dispatch(setLowGravity(checked))}
            />
          </div>
          <div className="border border-gray-300 p-2 w-full rounded-md flex items-center justify-between">
            <div className="flex flex-col items-start">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => dispatch(setControls(checked))}
            />
          </div>
          ...
          <div className="border border-gray-300 p-2 w-full rounded-md flex flex-col gap-2 items-start text-primary">
            ...
            <FlexRow>
              ...
              <div className="flex flex-col items-center">
                <FlexRow>
                  <Keycap activeKey="W">W</Keycap> <Keycap activeKey="A">A</Keycap> <Keycap activeKey="S">S</Keycap>{' '}
                  <Keycap activeKey="D">D</Keycap>
                </FlexRow>
                <h1 className="italic my-2 mx-4 text-accent">OR</h1>
                <FlexRow>
                  <Keycap activeKey="ArrowUp">↑</Keycap> <Keycap activeKey="ArrowLeft">←</Keycap>{' '}
                  <Keycap activeKey="ArrowDown">↓</Keycap> <Keycap activeKey="ArrowRight">→</Keycap>
                </FlexRow>
              </div>
            </FlexRow>

            <FlexRow>
              <h1 className="mr-3">Jump &mdash;</h1>{' '}
              <Keycap className="" activeKey="Space">
                Space
              </Keycap>
            </FlexRow>
