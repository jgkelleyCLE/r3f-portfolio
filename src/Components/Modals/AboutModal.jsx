          ...
          <FlexRow className="flex-col md:flex-row gap-4 text-primary">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="hidden md:block">
                ...
                <p className="my-4">
                  Transitioning into tech has been an exciting and fulfilling adventure. What started as tinkering with
                  our family business' Wordpress website, has grown into building large full-stack applications, aimed
                  at streamlining company inefficiencies and refining daily operations.
                </p>
              </div>
          ...
          <FlexRow className="mx-auto gap-4">
          {
            backSkills.map((item, index) => (
              ...
              <Button
                ...
                className="w-full mt-2 font-bold text-lg hover:bg-primary/80 cursor-pointer transition duration-300"
              >
                About Me Page
              </Button>
            </div>
